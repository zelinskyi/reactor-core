...
//	 ==============================================================================================================
	 ...
	 * the returned {@link Flux} when the given predicate returns false. Note that the
	 * element that triggers the predicate to return false (and thus closes a buffer) is
	 ...
	 * the returned {@link Flux} when the given predicate returns false. Note that the
	 * element that triggers the predicate to return false (and thus closes a buffer) is
	 * included as first element in the newly opened buffer.
	 * <p>
	 * <img class="marble" src="https://raw.githubusercontent.com/reactor/projectreactor.io/master/src/main/static/assets/img/marble/buffersize.png"
	 * alt="">
	 *
	 ...
	 * given predicate returns true. Note that the element that triggers the predicate
